...
const Hideki = () => {
    ...
    const deletarContatinho = (id) => {
        const contatinho = contatinhos.filter(contatinho => contatinho.id === id);
        const contatinhoValor = {...contatinho}
        const index = contatinhos.indexOf(contatinhoValor)
        console.log(contatinho)
        setContatinhos(contatinhos.splice(index, 1));
    };
