...
import Contatinhos from "./componentsHideki/Contatinhos";
import Titulo from "./componentsHideki/Titulo";
import Modal from "./componentsHideki/Modal";
import Button from "./componentsHideki/Button/index.jsx";
...
const Hideki = () => {
    ...
    const salvarContatinho = (evento) => {
        ...
        if (contatinhoAtual.id) {
            ...
            setContatinhos(prev => [...prev, contatinhoAtual])
        }
        fecharModal();
    }
                    ...
                    <form onSubmit={salvarContatinho} className="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full p-2 border border-red-800 rounded outline-none focus:border-red-500"
                                required
                            />
                        </div>
