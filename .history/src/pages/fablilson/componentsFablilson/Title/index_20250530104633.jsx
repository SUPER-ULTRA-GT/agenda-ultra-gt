...
const Title = () => {
    ...
    alt="Logo"
    className="h-30 w-auto rounded-full border-radius-full border-2 border-solid border-white shadow-lg shadow-gray-500 hover:shadow-gray-700 transition-shadow duration-300 transform hover:scale-105"
    />
