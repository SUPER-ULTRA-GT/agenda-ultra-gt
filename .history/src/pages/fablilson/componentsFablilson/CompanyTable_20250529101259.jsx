...
export default function titulo de emailTable() {
  return (
      ...
      <table className="min-w-full border border-gray-300 text-sm">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="border px-4 py-2 text-left">titulo de email</th>
        ...
        <tbody>
          {companies.map((item, index) => (
            <tr key={index} className="hover:bg-gray-50">
              ...
              <td className="border px-4 py-2">{item.titulo de email}</td>
